<template>
  <div class="app__wrapper">
      ...
      <div class="header__content">
        <div class="user">
          <img
            ...
            alt="User avatar"
          />
          <h2 class="user__name">Ricardo Cooper</h2>
        </div>
        <div class="contacts">
    ...
    <main class="main">
      <gallery-component @openModal="openModal" />
...
export default {
  name: "App",
  components: { GalleryComponent, ModalWindow },
  ...
  methods: {
    openModal(id) {
      ...
      document
        ...
        .classList.toggle("scroll-prevent", true);
    },
    closeModal() {
      this.selectedImgId = null;
      document
        .getElementsByTagName("body")[0]
        .classList.toggle("scroll-prevent", false);
    },
  },
};
</script>
